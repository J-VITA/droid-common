...
import kr.skyware.commons.http.util.Base64OutputStream;

public class SkyJsonStreamerEntity implements HttpEntity {
    private static final String LOG_TAG = "SkyJsonStreamerEntity";
    ...
    public SkyJsonStreamerEntity(ResponseHandlerInterface progressHandler, boolean useGZipCompression, String elapsedField) {
                ...
                try {
                    ...
                    if (value == null) {
                        ...
                        if (isFileWrapper || value instanceof RequestParams.StreamWrapper) {
                            ...
                            os.write('}');
                        } else if (value instanceof SkyJsonValueInterface) {
                            os.write(((SkyJsonValueInterface) value).getEscapedJsonValue());
