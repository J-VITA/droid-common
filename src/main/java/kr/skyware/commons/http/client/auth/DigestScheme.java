...
import kr.skyware.commons.http.header.BasicHeaderValueFormatter;
...
public class DigestScheme extends RFC2617Scheme {
     ...
     *
     * @throws kr.skyware.commons.http.exception.InvalidCredentialsException if authentication credentials
