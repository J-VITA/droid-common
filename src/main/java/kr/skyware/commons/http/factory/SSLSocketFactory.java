...
import kr.skyware.commons.http.connect.HttpInetSocketAddress;
import kr.skyware.commons.http.connect.ssl.AllowAllHostnameVerifier;
import kr.skyware.commons.http.connect.ssl.BrowserCompatHostnameVerifier;
import kr.skyware.commons.http.connect.ssl.SSLContexts;
import kr.skyware.commons.http.connect.ssl.StrictHostnameVerifier;
import kr.skyware.commons.http.connect.ssl.TrustStrategy;
 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link kr.skyware.commons.http.connect.ssl.SSLConnectionSocketFactory}.
 */
